...
void setup_scr_screen(lv_ui *ui)
{
    ...
    // Write codes screen_powerloss
    ui->screen_powerloss = lv_win_create(ui->screen);
    lv_obj_set_pos(ui->screen_powerloss, 7, 8);
    lv_obj_set_size(ui->screen_powerloss, 224, 119);
    lv_obj_set_scrollbar_mode(ui->screen_powerloss, LV_SCROLLBAR_MODE_OFF);
    lv_obj_add_flag(ui->screen_powerloss, LV_OBJ_FLAG_HIDDEN);
    lv_obj_t *screen_powerloss_title = lv_win_add_title(ui->screen_powerloss, "电源断开");
    lv_obj_t *screen_powerloss_header = lv_win_get_header(ui->screen_powerloss);
    lv_obj_set_height(screen_powerloss_header, 30);
    lv_obj_t *screen_powerloss_label = lv_label_create(lv_win_get_content(ui->screen_powerloss));
    lv_obj_set_scrollbar_mode(lv_win_get_content(ui->screen_powerloss), LV_SCROLLBAR_MODE_OFF);
    lv_label_set_text(screen_powerloss_label, "电源丢失！若5秒内无法恢复，\n系统将安全关机。\n\nE_FATAL_POWER_LOSS");

    // Write style for screen_powerloss, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_powerloss, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_powerloss, lv_color_hex(0xeeeef6), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_powerloss, LV_GRAD_DIR_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_width(ui->screen_powerloss, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_powerloss, 3, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(ui->screen_powerloss, lv_color_hex(0x2195f6), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui->screen_powerloss, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui->screen_powerloss, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_offset_x(ui->screen_powerloss, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_offset_y(ui->screen_powerloss, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write style state: LV_STATE_DEFAULT for &style_screen_powerloss_extra_content_main_default
    static lv_style_t style_screen_powerloss_extra_content_main_default;
    ui_init_style(&style_screen_powerloss_extra_content_main_default);

    lv_style_set_bg_opa(&style_screen_powerloss_extra_content_main_default, 255);
    lv_style_set_bg_color(&style_screen_powerloss_extra_content_main_default, lv_color_hex(0xeeeef6));
    lv_style_set_bg_grad_dir(&style_screen_powerloss_extra_content_main_default, LV_GRAD_DIR_NONE);
    lv_style_set_text_color(&style_screen_powerloss_extra_content_main_default, lv_color_hex(0x393c41));
    lv_style_set_text_font(&style_screen_powerloss_extra_content_main_default, &lv_font_SourceHanSansCNBold2_14);
    lv_style_set_text_opa(&style_screen_powerloss_extra_content_main_default, 255);
    lv_style_set_text_letter_space(&style_screen_powerloss_extra_content_main_default, 0);
    lv_style_set_text_line_space(&style_screen_powerloss_extra_content_main_default, 2);
    lv_obj_add_style(lv_win_get_content(ui->screen_powerloss), &style_screen_powerloss_extra_content_main_default, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write style state: LV_STATE_DEFAULT for &style_screen_powerloss_extra_header_main_default
    static lv_style_t style_screen_powerloss_extra_header_main_default;
    ui_init_style(&style_screen_powerloss_extra_header_main_default);

    lv_style_set_bg_opa(&style_screen_powerloss_extra_header_main_default, 255);
    lv_style_set_bg_color(&style_screen_powerloss_extra_header_main_default, lv_color_hex(0xe6e6e6));
    lv_style_set_bg_grad_dir(&style_screen_powerloss_extra_header_main_default, LV_GRAD_DIR_NONE);
    lv_style_set_text_color(&style_screen_powerloss_extra_header_main_default, lv_color_hex(0x393c41));
    lv_style_set_text_font(&style_screen_powerloss_extra_header_main_default, &lv_font_SourceHanSansCNBold2_20);
    lv_style_set_text_opa(&style_screen_powerloss_extra_header_main_default, 255);
    lv_style_set_text_letter_space(&style_screen_powerloss_extra_header_main_default, 0);
    lv_style_set_text_line_space(&style_screen_powerloss_extra_header_main_default, 2);
    lv_style_set_pad_top(&style_screen_powerloss_extra_header_main_default, 5);
    lv_style_set_pad_right(&style_screen_powerloss_extra_header_main_default, 5);
    lv_style_set_pad_bottom(&style_screen_powerloss_extra_header_main_default, 5);
    lv_style_set_pad_left(&style_screen_powerloss_extra_header_main_default, 5);
    lv_style_set_pad_column(&style_screen_powerloss_extra_header_main_default, 5);
    lv_obj_add_style(lv_win_get_header(ui->screen_powerloss), &style_screen_powerloss_extra_header_main_default, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write style state: LV_STATE_DEFAULT for &style_screen_powerloss_extra_btns_main_default
    static lv_style_t style_screen_powerloss_extra_btns_main_default;
    ui_init_style(&style_screen_powerloss_extra_btns_main_default);

    lv_style_set_radius(&style_screen_powerloss_extra_btns_main_default, 8);
    lv_style_set_border_width(&style_screen_powerloss_extra_btns_main_default, 0);
    lv_style_set_bg_opa(&style_screen_powerloss_extra_btns_main_default, 255);
    lv_style_set_bg_color(&style_screen_powerloss_extra_btns_main_default, lv_color_hex(0x2195f6));
    lv_style_set_bg_grad_dir(&style_screen_powerloss_extra_btns_main_default, LV_GRAD_DIR_NONE);
    lv_style_set_shadow_width(&style_screen_powerloss_extra_btns_main_default, 0);
